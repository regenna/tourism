        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaDD = table.Column<int>(type: "int", nullable: false),
                    DiemDenMaDD = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tours", x => x.MaTour);
                    table.ForeignKey(
                        name: "FK_Tours_DiemDens_DiemDenMaDD",
                        column: x => x.DiemDenMaDD,
                        principalTable: "DiemDens",
                        principalColumn: "MaDD");
                    table.ForeignKey(
                        name: "FK_Tours_DiemKhoiHanhs_DiemKhoiHanhMaDKH",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HinhAnhs_Tours_tourMaTour",
                        column: x => x.tourMaTour,
                        principalTable: "Tours",
                        principalColumn: "MaTour");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaiKhoans_TenTK",
                table: "TaiKhoans",
                column: "TenTK",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tours_DiemDenMaDD",
                table: "Tours",
                column: "DiemDenMaDD");

            migrationBuilder.CreateIndex(
                name: "IX_Tours_DiemKhoiHanhMaDKH",
                table: "Tours",
